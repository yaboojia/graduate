...
\titletwolines{基于子模型抽取的资源}{受限场景下联邦学习}
% \titleengtwolines{Federated Learning in Resource}{Constrained Based on Submodel Extraction}
% \titlethreelines{毕业论文题目第一行}{毕业论文题目第二行}{毕业论文题目第三行}
\titleengthreelines{Federated Learning with}{Submodel Extraction}
